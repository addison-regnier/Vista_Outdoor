            ...
            for (var nLine = 0; nLine < nLines; nLine++) {
                ...
                if (sLineGPL && sLineGPL !== '6') {
                    ...
                    if (pGPLConfig.hasOwnProperty(sLineGPL) && pGPLConfig[sLineGPL].SALES_REP && pGPLConfig[sLineGPL].SUB_REP) {
                        ...
                        /*
                            1. Create new tranLine field named GPL SubRep Name
                                A. Take pGPLConfig[sLineGPL].SUB_REP
                                B. Load Employee Record
                                C. get First & Last Name
                                D. Set new tranLine field w/ Name
